...
from data_analyzer import Processor
...
data = Parser.parse( file_path, File_Data_Source.SAP_AND_MOISTURE_SENSOR)
processor = Processor(data, File_Data_Source.SAP_AND_MOISTURE_SENSOR)
